...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kingkhan121:kingkhan121@cluster0.oteawfd.mongodb.net/?retryWrites=true&w=majority")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001909796512'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1001911817898'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1001911817898'))
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Movie_Url_link_downloader/17")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "4p56LpeEEdepjqavROJ2ccNoqfe2")
...
request_channel = environ.get('REQUEST_CHANNEL', '-1001909796512')
